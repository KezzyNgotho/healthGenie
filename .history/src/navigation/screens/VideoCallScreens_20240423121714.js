...
import { View, Text, StyleSheet, TouchableOpacity, Image, Alert,TextInput ,S} from 'react-native';
        ...
        <View style={styles.container}>
            ...
            <View style={styles.chatContainer}>
                ...
                <ScrollView 
                    ...
                    contentContainerStyle={styles.chatMessagesContent} // Added contentContainerStyle for styling the content inside ScrollView
                    ref={(scrollView) => { this.scrollView = scrollView; }} // ref to scroll to bottom on new message
                    onContentSizeChange={() => {        

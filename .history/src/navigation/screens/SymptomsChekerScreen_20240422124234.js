...
import { View, Text, StyleSheet, Button, TextInput, TouchableOpacity, Linking, Alert } from 'react-native';
...
const SymptomCheckerScreen = () => {
    ...
    const selectedSymptomsToDisplay = Array.isArray(selectedSymptoms) ? selectedSymptoms : [];
    ...
    useEffect(() => {
        ...
        // Check if the combined symptoms have changed before updating the state

...
import { View, Text, TouchableOpacity, StyleSheet, ScrollView, Alert, Image ,TextInput,RadioButton} from 'react-native';
...
const LevelSelector = ({ level, selectedLevel, onSelect, category }) => {
  const rows = [];
...
Voice.onSpeechResults = (e) => {
  ...
  selectedLevel={mood}
  onSelect={(level) => handleLevelSelect(level, 'mood')}
/>
      ...
      <LevelSelector
        ...
        onSelect={(level) => handleLevelSelect(level, 'AnxietyLevel')}
      ...
      <LevelSelector
        ...
        onSelect={(level) => handleLevelSelect(level, 'SleepQuality')}
      ...
      <LevelSelector
        ...
        onSelect={(level) => handleLevelSelect(level, 'EnergyLevel')}
      ...
      <LevelSelector
        ...
        onSelect={(level) => handleLevelSelect(level, 'StressLevel')}
      ...
      <LevelSelector
        ...
        onSelect={(level) => handleLevelSelect(level, 'SocialConnection')}
      ...
      <LevelSelector
        ...
        onSelect={(level) => handleLevelSelect(level, 'CopingMechanisms')}
        category={copingMechanisms}
      />
      ...
      <LevelSelector
        ...
        onSelect={(level) => handleLevelSelect(level, 'PersonalThoughts')}

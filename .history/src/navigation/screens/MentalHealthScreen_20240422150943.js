...
Voice.onSpeechResults = (e) => {
  ...
  const processUserMessage = async () => {
    try {
      // Combine all the user's selections and feelings into one message
      const combinedMessage = `
        ...
        Social Connections: ${socialConnection}
        Coping Mechanisms: ${Array.isArray(copingMechanisms) ? copingMechanisms.join(', ') : ''}
        Personal Thoughts: ${Array.isArray(personalThoughts) ? personalThoughts.join(', ') : ''}
        User's Feelings: ${message}
      `.trim();

...
const videoCameraOn = require('../assets/video-camera-on.png');
const videoCameraOff = require('../assets/video-camera-off.png');
const microphoneOn = require('../assets/microphone-on.png');
const microphoneOff = require('../assets/microphone-off.png');
const cameraSwitch = require('../assets/camera-switch.png');

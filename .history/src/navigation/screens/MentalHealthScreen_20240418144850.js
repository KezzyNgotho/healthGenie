...
Voice.onSpeechResults = (e) => {
  ...
  const processUserMessage = async (message) => {
    try {
      const apiKey = 'AIzaSyAoC4twZ9atgUGVESG17BukMccGFOvKwTU';
      const apiUrl = 'https://generativelanguage.googleapis.com/v1beta/models/gemini-pro:generateContent?key=${apiKey}'; // Replace with Gemini AI API endpoint
      ...
      // Assuming the API response has a 'response' field containing the AI's message
      const aiResponse = data.response;
  
      // Update the state or display the AI's response to the user

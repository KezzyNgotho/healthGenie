...
const AssistantScreen = () => {
    ...
    useEffect(() => {
        ...
        const genAIInstance = new GoogleGenerativeAI(GOOGLE_API_KEY, {
            endpoint: "https://generativelanguage.googleapis.com/v1beta/models/gemini-pro:generateContent"
        });
    }, []);
    ...
    const processUserMessage = async (userMessage) => {
        try {
            // Add "typing" message to indicate response is being generated
            setConversation(prevConversation => [...prevConversation, { speaker: 'assistant', message: 'Typing...' }]);
            ...
            setConversation(prevConversation => {
                ...
                updatedConversation.pop(); // Remove the "typing..." message
                return [...updatedConversation, { speaker: 'assistant', message: text }];
            });
        } catch (error) {
            console.error('Error generating response:', error);
            // Optionally, remove the "typing..." message if an error occurs
            setConversation(prevConversation => {
                const updatedConversation = [...prevConversation];
                updatedConversation.pop(); // Remove the "typing..." message
    ...
    const sendSymptomsAndHistory = () => {
        ...
        setConversation(prevConversation => [...prevConversation, { speaker: 'user', message: 'Symptoms and medical history sent.' }]);

...
const styles = StyleSheet.create({
  ...
  healthPlanContainer {
    background-color: #f5f5f5; /* Light gray background for better readability */
    border-radius: 5px; /* Rounded corners for a softer look */
    padding: 15px; /* Padding for spacing around content */
    margin-top: 20px; /* Margin for separation from previous content */
  }
  ,
  healthPlanTitle {
    font-weight: bold;

...
const AssistantScreen = () => {
    ...
    useEffect(() => {
        ...
        // Optionally, you can add any additional initialization code here
    ...
    const processUserMessage = async (userMessage) => {
        try {
            ...
            if (response.error) {
                console.error('GoogleGenerativeAI Error:', response.error);
                setConversation([...conversation, { speaker: 'assistant', message: 'Error generating response.' }]);
                return;
            }

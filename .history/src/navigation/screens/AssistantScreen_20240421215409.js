...
const AssistantScreen = () => {
    ...
    const [symptoms, setSymptoms] = useState('');
       ...
       // Define the endpoint for the Google Generative AI
       const ENDPOINT = 'https://generativelanguage.googleapis.com/v1beta1/models/gemini-pro:generateContent';

       const genAI = new GoogleGenerativeAI(GOOGLE_API_KEY, ENDPOINT);
       useEffect(() => {
        // Load environment variables
        const GOOGLE_API_KEY = process.env.GOOGLE_API_KEY;
